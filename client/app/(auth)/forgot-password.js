...
const ForgotPassword = () => {
    ...
    const { authLoading, authError, setAuthError, authMessage, setAuthMessage, forgotPassword } = useAuth();
    ...
    return (
        <SafeAreaView className='h-full flex-1 items-center justify-center bg-darkUmber-dark p-[20px]'>
            ...
            <View className='mx-auto w-full'>
                <Text className="text-chartreuse text-2xl font-rbold mb-2 text-center">Forgot Password?</Text>
            </View>
