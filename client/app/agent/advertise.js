                    ...
                    <View className='bg-transparentWhite w-full rounded-lg p-4'>
                        <View className="items-center justify-center">
                                ...
                                {isLoading ? (
                                    ...
                                    <>
                                        <Text className="text-white font-rbold text-2xl">
                                            {convertedPrice || `₦${DURATION_PRICES[selectedDuration].price.toLocaleString()}`}
                                        </Text>
                            ...
                            <Button
                                text="Continue"
                                bg={true}
                                onPress={() => router.push(`/agent/advertise-pay?propertyId=${propertyId}&duration=${selectedDuration}&amount=${convertedPrice || DURATION_PRICES[selectedDuration].price}`)}
                                // disabled={property.}
                            />
                        </View>
                    </View>
