                ...
                <View>
                    ...
                    <View className='bg-transparentWhite w-full rounded-lg p-4'>
                        <View className="items-center justify-center">
                            ...
                            <Text className="text-white font-rbold text-xl">Premium Plan</Text>
                            ...
                            <View className="items-center my-3">
                                {isLoading ? (
                                    ...
                                    <>
                                        ...
                                        <Text className="text-white font-rbold text-md">For 6 months</Text>
                            ...
                            <Button
                                text="Get Started"
                                bg={true}
                                onPress={() => router.push(`/agent/pay?amount=${convertedPrice || basePriceNGN}`)}
                            />
                        </View>
                    </View>
                </View>
