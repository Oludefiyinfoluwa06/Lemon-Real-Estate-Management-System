    ...
    return (
        <SafeAreaView className="h-full p-4 bg-darkUmber-dark">
            <View className="flex-row items-center mb-6">
                ...
                <Text className="font-rbold text-2xl text-white ml-3">Saved Properties</Text>
            </View>
                    ...
                    savedProperties.map((property) => (
                        ...
                        >
                            ...
                            <View className="flex-1 ml-4">
                                <Text className="text-white font-rbold text-lg" numberOfLines={1}>
                                    {property.title}
                                </Text>
                                <View className="flex-row items-center mt-1">
                                    <Ionicons name="location-outline" size={16} color="#BBCC13" />
                                    <Text className="text-frenchGray-light font-rregular text-sm ml-1" numberOfLines={1}>
                                        {property.country}
                                    </Text>
                                </View>
