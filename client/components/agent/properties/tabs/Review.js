...
const Review = ({ propertyId }) => {
    ...
    return (
        <ScrollView className="p-6">
            {!showReviewForm ? (
                <View>
                    <Text className="font-rbold text-2xl text-chartreuse mb-6">Reviews</Text>
                    ...
                    >
                        ...
                        <Text className="font-rregular text-white ml-2">Write a comment</Text>
                    </TouchableOpacity>
            ...
            {reviewMessage && <ErrorOrMessageModal
            ...
            {reviewError && <ErrorOrMessageModal
                visible={reviewError !== ""}
                modalType="error"
