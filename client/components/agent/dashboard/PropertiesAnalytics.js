...
const PropertiesAnalytics = ({
    ...
    const totalProperties = propertyData.totalForSale + propertyData.totalForRent + propertyData.totalForLease;
    ...
    return (
        <View className="bg-frenchGray-dark rounded-xl p-3">
            ...
            {totalProperties > 0 ? (
                ...
                <Text className="font-rbold text-white text-left">No properties available for sale, rent, or lease.</Text>
            )}
        </View>
    );
};
