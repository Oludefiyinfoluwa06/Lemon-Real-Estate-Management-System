    ...
    return (
        ...
        >
            <View className='flex-row items-center justify-start gap-2'>
                <Ionicons name={agentTypeIcon} size={20} color={'#AFAFAF'} />
                <Text className='text-white font-rbold'>Continue as {agentType === 'Individual' ? 'an' : 'a'} {agentType}</Text>
            </View>
            <Ionicons name='arrow-forward-outline' size={20} color={'#AFAFAF'} />
        </TouchableOpacity>
    )
}
