...
import { Text, View, TouchableOpacity, TextInput, Animated, Dimensions, Modal } from 'react-native';
            ...
            <View className="flex-1 justify-end bg-transparentBlack">
                ...
                <View className="bg-darkUmber-dark rounded-t-3xl p-4 h-[470px]">
                    <View className="flex-row justify-between items-center mb-4">
                        <Text className="text-white text-lg font-rbold">Filter Options</Text>
                    ...
                    <View className="mb-4">
                        <Text className="text-frenchGray-light mb-2 font-rregular">Country</Text>
                        <TextInput
                    ...
                    <View className="mb-4">
                        <Text className="text-frenchGray-light mb-2 font-rregular">Category</Text>
                        <TextInput
                    ...
                    <View className="mb-4">
                        <Text className="text-frenchGray-light mb-2 font-rregular">Status</Text>
                        <TextInput
                    ...
                    <View className="flex-row justify-between mb-4">
                        <View className="flex-1 mr-2">
                            <Text className="text-frenchGray-light mb-2 font-rregular">Min Price</Text>
                            <TextInput
                        ...
                        <View className="flex-1 ml-2">
                            <Text className="text-frenchGray-light mb-2 font-rregular">Max Price</Text>
                            <TextInput
                    ...
                    >
                        <Text className="text-darkUmber-dark text-lg font-rsemibold">Apply Filters</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </Modal>
